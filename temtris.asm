...
PaletyPoziomow:
    ...
    .byte $0F, $0C, $1C, $2C ; 6
    .byte $0F, $0A, $1A, $2A ; 7
    .byte $0F, $10, $20, $0F ; 8 ; nowe kolory trochę na pałe
    .byte $0F, $16, $26, $0F ; 9
    .byte $0F, $18, $27, $0F ; 10
    .byte $0F, $12, $21, $0F ; 11
    .byte $0F, $27, $37, $0F ; 12
...
NeverGonnaP:
    ...
    .byte %10101000, %11110000, %00000000
    .byte %00011010, %10111000, %00010111
    .byte %00011010, %10111000, %00011110
    .byte %10101000, %11111111, %00000000
    .byte %00000000, %11101110, %00001111
    .byte %00000000, %11010100, %00001111
    ...
    .byte %10101000, %11110000, %00000000
    .byte %00011010, %10111000, %00010110
    .byte %10101000, %11111111, %00000000
    .byte %00000001, %00001100, %00000111
    .byte %00000000, %11101110, %00001000
    .byte %00000000, %11001000, %00000111
    ...
    .byte %00000000, %10011111, %00001111
    .byte %10101000, %11110000, %00000000
    .byte %00011010, %10111000, %00000111
    .byte %10101000, %11111111, %00000000
    ...
    .byte %00000010, %00011001, %00011110
    .byte %10101000, %11110000, %00000000
    .byte %00011010, %10111000, %01111000
    .byte %00011010, %10111000, %01111000
    .byte %00011010, %10111000, %01111000
    .byte %00011010, %10111000, %01111000
...
NeverGonnaT:
    ...
    .byte %00011010, %10111000, %00010111
    .byte %10101000, %11111111
    .byte %00000010, %01011011, %00000111
    .byte %00000001, %11011110, %00001000
    .byte %00000001, %11011110, %00000111
    .byte %10101000, %00000000
    .byte %00011010, %10111000, %00001000
    ...
    .byte %00011010, %10111000, %00010111
    .byte %10101000, %11111111
    .byte %00000000, %01011000, %00001111
    .byte %00000000, %01011000, %00111100
    .byte %00000000, %01001111, %00101101
    .byte %00000010, %01111111, %00000111
    .byte %00000001, %11011110, %00000100
    .byte %10101000, %00000000
...
PrawdaOPolskimPapiezu:
    ...
    .byte $32, $31, $33, $37, $20, $4A, $61, $6E, $20, $50, $61, $70, $69, $65, $BF, $20, $49, $49, $20, $67, $77, $61, $B3, $63, $69, $B3, $20, $6D, $61, $B3, $65, $20, $64, $7A, $69, $65, $63, $69
